...
4. Настройка хранилищ данных и признаков
   * Конкретность:
      * Сбор транзакций из системы заказчика в s3 за фиксированный период (н.р., 60 минут)
      * Разработка модуля анонимизации
      * Разработка пайплайна для выгрузки анонимизированных данных из хранилища признаков аналитикам
