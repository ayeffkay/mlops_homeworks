...
Верхнеуровнево антифрод-система должна содержать следующие части:
  ...
  * Хранилища данных и признаков для обработки транзакций с помощью модели/правил
...
4. Настройка хранилищ данных и признаков
   * Конкретность:
      * Сбор транзакций из системы заказчика в hdfs за фиксированный период (н.р., 60 минут)
