...
$$
profit\_per\_month = \sum_{i=1}^{\left|fraud_transactions\right|} \Big[ TP_i \cdot \left(customer\_churn\_damage_i + transaction\_amount_i\right) - FN_i \cdot \left(customer\_churn\_damage_i + transaction\_amount_i\right) - FP_i \cdot customer\_churn\_damage_i \Big]
$$
